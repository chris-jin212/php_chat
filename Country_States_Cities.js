	...
	can_city_arr[0]  = new Array("Ahmadpur","Ahmed Nager Chatha","Ali Khan Abad","Alipur","Arifwala","Attock","Bhera","Bhalwal","Bahawalnagar" ,"Bahawalpur","Bhalwal","Bhakkar","Burewala","Chillianwala","Chakwal","Chichawatni","Chiniot","Chishtian","Daska","Darya Khan","Dra Ghazi Khan","Dhaular","Dina","Dinga","Dipalpur","Fateh Jang","Faisalabad","Ghakhar Mandi","Gojra","Gujranwala","Gujrat","Gujar Khan","Hafizabad","Haroonabad","Hasilpur","Haveli Lakha","Jalalpur Jattan","Jampur","Jaranwala","Jauharabad","Jhang","Jhelum","Kalabagh","Karor Lal Esan","Kamalia","Kāmoke","Kasur","Khanewal","Khanpur","Kharian","Khushab","Kot Adu","Lahore","Lalamusa","Layyah","Liaquat Pur","Lodhran","Malakwal","Mamoori","Mailsi","Mandi Bahauddin","Mian Channu","Mianwali","Multan","Murree","Muridke","Mianwali Bangla","Muzaffargarh","Narowal","Okara","Renala Khurd","Pakpattan","Pattoki","Pir Mahal","Qaimpur","Qila Didar Singh","Rabwah","Raiwind","Rajanpur","Rahim Yar Khan","Rawalpindi","Sadiqabad","Safdarabad","Sahiwal","Sangla Hill","Sarai Alamgir","Sargodha","Shakargarh","Shekhupura","Sialkot","Sohawa","Soianwala","Siranwali","Talagang","Taxila","Toba Tek Singh","Vehari","Wah Cantonment","Wazirabad");

	can_city_arr[1]  = new Array("Badin","Bhirkan","Chak","Dadu","Digri","Diplo","Dokri","Ghotki","Haala","Hyderabad","Islamkot","Jacobabad","Jamshoro","Jungshahi","Kandhkot","Kandiaro","Karachi","Kashmore","Keti Bandar","Khairpur","Kotri","Larkana","Matiari","Mehar","Mirpur Khas","Mithani","Mithi","Mehrabpur","Moro","Nagarparkar","Naudero","Naushahro Feroze","Naushara","Nawabshah","Nawabshah","Nazimabad","Qambar","Qasimabad","Rajo Khanani","Ranipur","Ratodero","Rohri","Sakrand","Sanghar","Shahbandar","Shahdadkot","Shahdadpur","Shahpur Chakar","Shikarpur","Sukkur","Tangwani","Tando Adam","Tando Allahyar","Tando Muhammad Khan","Thatta","Umerkot","Warah");

	can_city_arr[2]  = new Array("Abbottabad","Adezai","Alpuri","Akora Khattak","Ayubia","Banda Daud Shah","Bannu","Batkhela","Battagram","Birote","Chakdara","Charsada","Chitral","Daggar","Dargai","Darya Khan","Dera Ismail Khan","Doaba","Dir","Drosh","Hangu","Haripur","Karak","Kohat","Kulachi","Lakki Marwat","Latamber","Madyan","Mansehra","Mardan","Mastuj","Mingora","Nowshera","Paharpur","Pabbi","Peshawar","Saidu","Sharif","Shorkot","Shewa Adda","Swabi","Tangi","Tank","Thall","Timergara","Tordher");

	can_city_arr[3]  = new Array("Chaman","Dera Murad Jamali","Dera Allah Yar","Gwadar","Hub","Kalat","Kharan","Loralai","Mastung","Nushki","Pasni","Khuzdar","Quetta","Sibi","Turbat","Usta Mohammad","Zhob");
	...
	//var uk_state_Arr  = new Array("England","Northern Ireland","Scotland","Wales","Others");
	var uk_state_Arr  = new Array("England","Northern Ireland","Scotland","Wales");
	var uk_city_arr = new Array();

	uk_city_arr[0]  = new Array("Bedfordshire","Berkshire","Buckinghamshire","Cambridgeshire","Cheshire","Cornwall","Cumbria","Derbyshire","Devon","Dorset","Durham","Essex","Gloucestershire","Hampshire","Hertfordshire","Huntingdonshire","Kent","Lancashire","Leicestershire","Lincolnshire","Middlesex","Norfolk","Northamptonshire","Northumberland","Nottinghamshire","Oxfordshire","Rutland","Shropshire","Somerset","Staffordshire","Suffolk","Surrey","Sussex","Warwickshire","Westmoreland","Wiltshire","Worcestershire","Yorkshire");

	uk_city_arr[1]  = new Array("Antrim","Armagh","Down","Fermanagh","Londonderry","Tyrone");

	uk_city_arr[2]  = new Array("Ayrshire","Borders","Central Scotland","Dumfries and Galloway","Dunbartonshire and Argyll & Bute","Fife","Grampian","Glasgow","Highlands and Western Isles","Lanarkshire","Lothian","Orkney and Shetland","Renfrewshire","Tayside");

	uk_city_arr[3]  = new Array("Blaenau Gwent","Bridgend","Caerphilly","Cardiff","Carmarthenshire","Ceredigion","Conwy","Denbighshire","Flintshire","Gwynedd"," Isle of Anglesey"," Merthyr Tydfil","Monmouthshire","Neath Port Talbot","Newport","Pembrokeshire","Powys"," Rhondda Cynon Taff"," Swansea","Torfaen","Vale of Glamorgan","Wrexham");

	// uk_city_arr[4]  = new Array("Others");
...
function enb(fld)
{
	...
	if( fld=='country' ) {
		...
		if (v == 'india') {
			...
			var uk_state_arr_length = uk_state_Arr.length;
			ex_len = document.formn.select_state.length;
			for(k=(ex_len - 1); k > 0; k--)
			{
				document.formn.select_state.options[k] = null;
			}
			for(i=0;i<uk_state_arr_length;i++)
			{
				option0 = new Option(uk_state_Arr[i], uk_state_Arr[i]);
			 	document.formn.select_state.options[document.formn.select_state.length]=option0;
			}
			//option0 = new Option("Others", "Others");
			//document.formn.select_state.options[document.formn.select_state.length]=option0;
			...
			option0 = new Option(uk_state_arr[i],uk_state_arr[i]);
			// alert('state_arr[i]: '+state_arr[i]);
			// alert('document.formn.select_city.length: '+document.formn.select_city.length);
	...
	if( fld =='state' ) {
		...
		// alert('us_state_Arr_length: '+us_state_Arr_length);
		...
		var can_state_Arr_length = can_state_Arr.length;
		// alert('can_state_Arr_length: '+can_state_Arr_length);
		for(i=0;i<can_state_Arr_length;i++) {
		...
		// alert('uae_state_Arr_length: '+uae_state_Arr_length);
		...
		var uk_state_Arr_length = uk_state_Arr.length;
		// alert('uk_state_Arr_length: '+uk_state_Arr_length);
		for(i=0;i<uk_state_Arr_length;i++) {
			if( uk_state_Arr[i]==st ) {
				local_state_match = 1;
				var uk_city_arr_length = uk_city_arr[i].length;
				ex_len = document.formn.select_city.length;
				for(k=(ex_len - 1); k > 0; k--)
				{
					document.formn.select_city.options[k] = null;
				...
				// alert('uk_city_arr_length' + uk_city_arr_length);
				for(j=0;j<uk_city_arr_length;j++)
				{
					option0 = new Option(uk_city_arr[i][j], uk_city_arr[i][j]);
					document.formn.select_city.options[document.formn.select_city.length]=option0;
				}
				option0 = new Option("Others", "Others");
				document.formn.select_city.options[document.formn.select_city.length]=option0;
	...
	} else if (document.formn.select_country.value == 'pakistan' ) {
		// not much to do here
		// alert('Pakistan');
	} else if (document.formn.select_country.value == 'united kingdom' ) {
		// not much to do here
	} else if (document.formn.select_country.value == 'united arab emirates') {
		// not much to do here
		// alert('UAE');
	} else if (document.formn.select_country.value == 'united states of america') {
		// not much to do here
	} else {
...
function sel_state()
{
	...
	state_flag = 0;
	city_flag  = 0;
	if( fld == 'united states of america' || fld == 'india' || fld == 'pakistan' || fld == 'united kingdom' || fld == 'united arab emirates') {
 		if ( fld == 'united states of america')
		 arr = 'us_state_Arr';
		else if( fld == 'pakistan' )
			arr = 'can_state_arr';
		else if( fld == 'united kingdom')
			arr = 'uk_state_arr';
