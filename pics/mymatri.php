...
<TR>
<TD width="180" height="303" valign="top" bgcolor="#FFFFCC">
        ...
        <td width="2236" colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td><fieldset class="fieldset">
                <legend class="bluetext"><a href="payment_options.php"></a><img src="pics/myprofile-icontxt.gif"/></legend>
...
<?php } ?>		<BR/>	
      ...
      <tr>
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><fieldset >
                <legend><img src="pics/chklist-icontxt.gif"/></legend>
                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFCC">
                  <tbody>
                    <tr>
                      <td height="18">&nbsp;</td>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td width="28%"><img src="pics/<?php echo $row['photochecklist'] ?>"> </td>
                      <td width="19%">Horoscope : </td>
                      <td width="37%"><img src="pics/<?php echo $row['Horoschecklist'] ?>"></td>
                    </tr>
                  </tbody>
                </table>
              </fieldset></td>
      ...
      <tr>
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td>
			 	<BR/>
			   <?php include("myint_inc.php");?>	<BR/>
			  <?php include("mymessage_inc.php");?><BR/> 
